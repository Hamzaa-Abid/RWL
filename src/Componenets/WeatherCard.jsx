...
import { loadLocation, settingsData } from "../store/reducers/settingsReducer";
...
const WeatherCard = () => {
    ...
    }, [currentLanguage, getLocationData]);
                                            ...
                                            <Dropdown.Menu style={{ backgroundColor: "#1A2E51" }}>
                                                {languagesData &&
                                                    languagesData.map((data, index) => {
                                                        return (
                                                            <Dropdown.Item key={index} id="btnLogout" onClick={() => languageChange(data.language, data.code, data.id, data.display_name)}>
