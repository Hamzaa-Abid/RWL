...
import { categoriesApi, deleteImageApi, getLocationApi, getSubcategoryByCategoryApi, gettagsApi, setNewsApi } from "../store/actions/campaign";
                                        ...
                                        {getLocationData === "1" ? (
                                            <div className="dropdown_form mb-2">
                                                <Select
                                                    ...
                                                    onChange={(value) => setDefaultValue({ ...DefaultValue, defualtLocationId: value, defualtLocation: value })} // Update defaultValue using setDefaultValue
                                                >
