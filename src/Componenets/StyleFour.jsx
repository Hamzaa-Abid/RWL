                                        ...
                                        {Data.videos.map((value, index) => {
                                            return (
                                                <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                                                    <div id="rns-card" className="card card_hover_two" key={index.id} onClick={() => { handleVideoUrl(value.content_value); TypeUrl(value.type) }}>
                                ...
                                <div id="rns-head-main" className="">
                                    ...
                                    <div className="row">
                                        {Data.news.map((value, index) => {
                                            return (
                                                <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                                                    <Link id="rns-card" className="card card_hover_two" key={index.id} to={`/news/${value.id}/${value.category_id}`}>
                                                        <div className="banner_thumb">
                                                            <img id="rns-image" src={value.image} className="card-img-top" alt="news" onError={placeholderImage}/>
                                                        </div>
                                                        <div id="rns-img-overlay" className=" card-inverse">
                                ...
                                <div id="rns-cards-main" className="">
                                    ...
                                    <div className="row">
                                        {Data.breaking_news.map((value, index) => {
                                            return (
                                                <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                                                    <Link id="rns-card" className="card card_hover_two" key={index.id} to={`/breaking-news/${value.id}`}>
                                                    <div className="banner_thumb">
                                                            <img id="rns-image" src={value.image} className="card-img-top" alt="news" onError={placeholderImage}/>
                                                        </div>
                                                        <div id="rns-card-body" className="card-block">
